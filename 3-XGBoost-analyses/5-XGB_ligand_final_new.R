...
write_rds(expression.data, "./Data/rna_seq_data/all_lines.rds")
...
saveRDS(XGB.model,"./XGB_models_null/xgb_ligands|random|11_01_2022.RDS")
...
saveRDS(XGB.model,"./XGB_models_null/xgb_ligands|rna_only|11_01_2022.RDS")
...
saveRDS(XGB.model,"./XGB_models_null/xgb_ligands|aff_chop_only|11_01_2022.RDS")
...
saveRDS(XGB.model,"./XGB_models_null/xgb_ligands|aff_only|11_01_2022.RDS")
...
Full_data %>% 
  dplyr::select(-c(affMIN, chop, rna)) %>% 
  train(as.factor(ligand)~. ,
        data=.,
        method="xgbTree",
        trControl=control,
...
saveRDS(XGB.model,"./XGB_models_null/xgb_ligands|library_only|23_12_21.RDS")
...
saveRDS(XGB.model,"./XGB_models_null/xgb_ligands|rna_aff_chop|11_01_2022.RDS")
...
saveRDS(XGB.model,"./XGB_models_null/xgb_ligands|Library_chop_aff|23_12_21.RDS")
...
saveRDS(XGB.model,"./XGB_models_null/xgb_ligands|Library_rna_chop_aff|11_01_2022.RDS")
